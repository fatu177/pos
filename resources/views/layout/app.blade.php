...
<html
    ...
    data-assets-path="{{ asset('assets/fe/assets/') }}"
...
>
    ...
    <body>
                    ...
                    <ul class="menu-inner py-1">
                       ...
                       @php
                        $nama_level=Auth::user()->level->nama_level;
                            if ($nama_level == 'Kasir' or $nama_level == 'Pimpinan') {
                                echo "hidden";
                            }
                        @endphp
                        >
                       ...
                       @php
                        ...
                        <li class="menu-item @yield('KategoriBarang')"
                        @php
                        $nama_level=Auth::user()->level->nama_level;
                            if ($nama_level == 'Kasir' or $nama_level == 'Pimpinan') {
                                echo "hidden";
                        ...
                        >
                            <a
                                href="{{ route('KategoriBarang.index') }}"
                                class="menu-link"
                            >
                                <div data-i18n="Without navbar">
                                    Kategori Barang
                        ...
                        @php
                        $nama_level=Auth::user()->level->nama_level;
                            if ($nama_level == 'Kasir' or $nama_level == 'Administrator') {
                                echo "hidden";
                            }
                        @endphp
                        >
                        ...
                        @php
                        $nama_level=Auth::user()->level->nama_level;
                            if ($nama_level == 'Administrator' or $nama_level == 'Pimpinan') {
                                echo "hidden";
                            }
                        @endphp
                        >
                                ...
                                >
                                    ...
                                    >
                                        <div class="avatar avatar-online">
                                            <img
                                                src="{{ asset('assets/fe/assets/img/avatars/1.png') }}"
                                                alt
        ...
        <!-- Vendors JS -->
        <script src="{{ asset('assets/fe/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>
